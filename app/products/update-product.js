$(document).ready(function(){
    ...
    $(document).on('click', '.update-product-button', function(){
       ...
       // read one record based on given product id
        $.getJSON("http://localhost/php/api/product/read_one.php?id=" + id, function(data){
            ...
            $.getJSON("http://localhost/php/api/category/read.php", function(data){
                ...
                update_product_html+="<table class='table table-hover table-responsive table-bordered'>";
                    ...
                    update_product_html+="<tr>";
                        ...
                        update_product_html+="<td><input value=\"" + id + "\" name='id' type='hidden' /><input value=\"" + modified + "\" name='modified' type='hidden' /><input value=\"" + created + "\" name='created' type='hidden' /></td>";
    ...
    $(document).on('submit', '#update-product-form', function(){
        ...
        $.ajax({
            url: "http://localhost/php/api/product/update.php",
            type : "POST",
